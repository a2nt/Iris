...
copyfile(
  "node_modules/libflacjs/dist/libflac.min.js",
  "mopidy_iris/static/libflac.min.js",
  function (error) {
    if (error) {
      console.log("Build failed, could not copy manifest.json", error);
      return false;
    }
    console.log("Copied libflac.min.js");
  }
);
...
copydir(
  ...
  function (error) {
    ...
    init_file_content = init_file_content.replace(
      /(?:__version__\ \=\ \")(?:.*)"/,
      '__version__ = "' + version + '"'
    );
    ...
    cfg_file_content = cfg_file_content.replace(
      /(?:version\ \=\ )(?:.*)/,
      "version = " + version
    );
    ...
    package_file_content = package_file_content.replace(
      /(?:\"version\"\:\ \")(?:.*)"/,
      '"version": "' + version + '"'
    );
